...
| redisMonitoringReqQuotaAcquireRetryTimeMs              | -1                              | Redis monitoring requests quota acquire retry delay time [ms]. Use **-1** to reject immediately                                                                                                                  |
| checkQueueRequestsQuotaAcquireRetryTimeMs              | -1                              | Check queue requests quota acquire retry delay time [ms]. Use **-1** to reject immediately                                                                                                                       |
