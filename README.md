...
| redisMonitoringReqQuotaAcquireTimeoutMs              | 0                               | Redis monitoring requests quota acquire timeout [ms]. Use **0** to reject immediately                                                                                                                            |
| checkQueueRequestsQuotaAcquireTimeoutMs              | 0                               | Check queue requests quota acquire timeout [ms]. Use **0** to reject immediately                                                                                                                                 |
| queueStatsRequestQuotaAcquireTimeoutMs               | 0                               | Queue stats requests quota acquire timeout [ms]. Use **0** to reject immediately                                                                                                                                 |
