...
| dequeueStatisticReportIntervalSec       | 0                               | The interval [s] to publish the dequeue statistics into shared map. Use **0** to not publish at all. In a hazelcast-cluster environment need config Semaphore first, see: https://github.com/vert-x3/vertx-hazelcast/blob/master/src/main/asciidoc/index.adoc#using-an-existing-hazelcast-cluster |
### Configuration util
