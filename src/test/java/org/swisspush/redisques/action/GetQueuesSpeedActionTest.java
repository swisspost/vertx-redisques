...
public class GetQueuesSpeedActionTest extends AbstractQueueActionTest {
    ...
    @Test
    public void testGetQueuesSpeedWhenRedisIsNotReady(TestContext context){
        when(redisProvider.redis()).thenReturn(Future.failedFuture("not ready"));
        when(message.body()).thenReturn(buildGetQueuesSpeedOperation(null));
    ...
    @Test
    public void testGetQueuesSpeedWithFilterWhenRedisIsNotReady(TestContext context){
        when(redisProvider.redis()).thenReturn(Future.failedFuture("not ready"));
        when(message.body()).thenReturn(buildGetQueuesSpeedOperation("abc"));
