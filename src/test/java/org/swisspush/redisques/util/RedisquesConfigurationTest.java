...
public class RedisquesConfigurationTest {
    ...
    public void testDefaultConfiguration(TestContext testContext) {
        ...
        testContext.assertFalse(config.getMicrometerPerQueueMetricEnabled());
    ...
    public void testOverrideConfiguration(TestContext testContext) {
        ...
        testContext.assertTrue(config.getMicrometerPerQueueMetricEnabled());
    ...
    public void testGetDefaultAsJsonObject(TestContext testContext) {
        ...
        testContext.assertFalse(json.getBoolean(PROP_MICROMETER_PER_QUEUE_METRICS_ENABLED));
    ...
    public void testGetOverriddenAsJsonObject(TestContext testContext) {
        ...
        testContext.assertTrue(json.getBoolean(PROP_MICROMETER_PER_QUEUE_METRICS_ENABLED));
