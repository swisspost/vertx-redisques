...
public class DeleteLockAction extends AbstractQueueAction {
    ...
    public DeleteLockAction(Vertx vertx, LuaScriptManager luaScriptManager, RedisAPIProvider redisAPIProvider, String address, String queuesKey, String queuesPrefix,
