...
public class RedisquesAPI {
    ...
    public static final String EXCLUDE_DEQUEUE_STATES = "excludeDequeueStates";
    ...
    public static final String PER_QUEUE_CONFIG_NUMBER_OF_ITEM_BATCH_DISPATCH =  "numberOfBatchItemDispatch";
    ...
    public static JsonObject buildGetQueuesOperation(String filterPattern) {
        if (filterPattern != null) {
            ...
            return buildGetQueuesOperation();
        }
    }
    ...
    public static JsonObject buildGetQueuesCountOperation(String filterPattern) {
        if (filterPattern != null) {
            ...
            return buildGetQueuesCountOperation();
        }
    }
    ...
    public static JsonObject buildMonitorOperation(boolean includeEmptyQueues, Integer limit) {
        JsonObject payload = new JsonObject().put(EMPTY_QUEUES, includeEmptyQueues);
        if (limit != null) {
            payload.put(LIMIT, limit);
        }
        return buildOperation(QueueOperation.monitor, payload);
    }
