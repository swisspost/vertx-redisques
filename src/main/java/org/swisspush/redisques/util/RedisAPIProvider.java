...
public class RedisAPIProvider {
    ...
    private final RedisquesConfiguration redisquesConfiguration;
    ...
    public RedisAPIProvider(Vertx vertx, RedisquesConfiguration redisquesConfiguration) {
        this.vertx = vertx;
        this.redisquesConfiguration = redisquesConfiguration;
        this.redisReconnectAttempts = redisquesConfiguration.getRedisReconnectAttempts();
        this.redisReconnectDelaySec = redisquesConfiguration.getRedisReconnectDelaySec();
    }
    ...
    private Future<RedisAPI> createRedisClient() {
        ...
        String redisHost = redisquesConfiguration.getRedisHost();
        int redisPort = redisquesConfiguration.getRedisPort();
        String redisAuth = redisquesConfiguration.getRedisAuth();
        int redisMaxPoolSize = redisquesConfiguration.getMaxPoolSize();
        int redisMaxPoolWaitingSize = redisquesConfiguration.getMaxPoolWaitSize();
        int redisMaxPipelineWaitingSize = redisquesConfiguration.getMaxPipelineWaitSize();
